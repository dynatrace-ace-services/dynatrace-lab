...
#unique id
export config="config-id"
#export variables application
export HostGroup="easytravelxx"
export DonainName="yyy.zzz.dynatrace.com"
export Email="myemail@email.com"
#synthetic location (for live.dynatrace.com)
export PublicSyntheticLocation1="GEOLOCATION-8A751DADED5D705A" #Marseille_Azure
export PublicSyntheticLocation2="GEOLOCATION-E266126A762728A2" #Paris_AWS
